...
void setup() {
  ...
  TF_LITE_REPORT_ERROR(error_reporter, "start");
...
void loop() {
  ...
  int scoresCollect[4];
  recognizer->getPreviousResultScores(scoresCollect);
  for (int itr = 0; itr < 4; ++itr) {
    Serial.print("Debug: scoresCollect[itr]: ");
    Serial.println(scoresCollect[itr]);
  }                   
}
